...
kenya_2009_df <- read.csv(file = "C:\\Users\\Mikki\\OneDrive - Tulane University\\Documents\\sampling\\GitHub\\IHSD_7440_HH_Sampling\\kenya2009_household_1.csv")
...
se.urban <-sqrt(var(Urban.electr$Has_electricity,na.rm=TRUE)/length(na.omit(Urban.electr$Has_electricity)))#calculates standard error #na.rm / na.omit ignores missing values
